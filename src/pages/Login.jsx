  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center bg-gray-50 px-6">
      <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
        ...
        <p className="text-gray-500 text-center mb-8 text-sm">Login to your MakizhTech account</p>
        ...
        <form className="space-y-4">
          ...
          <button className="w-full bg-black text-white py-3 rounded-lg font-bold hover:bg-gray-800 transition active:scale-95">Login</button>
        </form>

        <p className="text-center mt-6 text-sm text-gray-600">
          Don't have an account? <Link to="/register" className="text-yellow-600 font-bold hover:underline">Register</Link>
        </p>
      </div>
    </div>
  );
